...
const config = {
  ...
  GIT_GITIGNORE_ENTRIES: process.env.GIT_GITIGNORE_ENTRIES
    ...
    : ["node_modules/", ".pnpm-store/", "dist/", "build/", ".idea/", ".vscode/", ".DS_Store", ".npmrc", ".agents/", ".claude/", ".opencode/", ".codex/", ".grok/", ".pi/", ".tmp/", ".logs/", "pnpm-lock.yaml", "yarn.lock", "package-lock.json"],
